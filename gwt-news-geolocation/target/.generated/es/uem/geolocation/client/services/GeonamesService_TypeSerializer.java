...
public class GeonamesService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["es.uem.geolocation.shared.Toponym/1913196496"] = [
        @es.uem.geolocation.shared.Toponym_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @es.uem.geolocation.shared.Toponym_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Les/uem/geolocation/shared/Toponym;),
      ];
    
    result["[Les.uem.geolocation.shared.Toponym;/1442410329"] = [
        @es.uem.geolocation.shared.Toponym_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @es.uem.geolocation.shared.Toponym_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Les/uem/geolocation/shared/Toponym;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@es.uem.geolocation.shared.Toponym::class)] = "es.uem.geolocation.shared.Toponym/1913196496";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@es.uem.geolocation.shared.Toponym[]::class)] = "[Les.uem.geolocation.shared.Toponym;/1442410329";
  ...
  public GeonamesService_TypeSerializer() {
