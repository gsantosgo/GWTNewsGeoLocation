...
public class RSSService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.google.gwt.jsio.client.JSONWrapperException/668968777"] = [
        @com.google.gwt.jsio.client.JSONWrapperException_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.google.gwt.jsio.client.JSONWrapperException_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/google/gwt/jsio/client/JSONWrapperException;),
      ];
    
    result["com.google.gwt.jsio.client.MultipleWrapperException/819638067"] = [
        @com.google.gwt.jsio.client.MultipleWrapperException_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.google.gwt.jsio.client.MultipleWrapperException_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/google/gwt/jsio/client/MultipleWrapperException;),
      ];
    ...
    result["es.uem.geolocation.shared.NewMap/647926835"] = [
        @es.uem.geolocation.shared.NewMap_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @es.uem.geolocation.shared.NewMap_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Les/uem/geolocation/shared/NewMap;),
      ];
    
    result["[Les.uem.geolocation.shared.NewMap;/4220857610"] = [
        @es.uem.geolocation.shared.NewMap_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @es.uem.geolocation.shared.NewMap_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Les/uem/geolocation/shared/NewMap;),
      ];
    
    result["es.uem.geolocation.shared.RSS/1293983799"] = [
        @es.uem.geolocation.shared.RSS_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @es.uem.geolocation.shared.RSS_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Les/uem/geolocation/shared/RSS;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.google.gwt.jsio.client.JSONWrapperException::class)] = "com.google.gwt.jsio.client.JSONWrapperException/668968777";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.google.gwt.jsio.client.MultipleWrapperException::class)] = "com.google.gwt.jsio.client.MultipleWrapperException/819638067";
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@java.util.concurrent.ExecutionException::class)] = "java.util.concurrent.ExecutionException/1787452083";
  ...
  public RSSService_TypeSerializer() {
