...
public class MapViewImpl<T> extends Composite implements MapView<T> {
	...
	public MapViewImpl() {
		...
		elpaisPortadaMenuItem.setCommand(new Command() {			
			//@Override
			public void execute() {
				setFuenteRSSLink(Constant.MENU_LIST.get("elpaisUltimaNoticiasMenuItem"));				
	...
	public void setPresenter(
			es.uem.geolocation.client.view.MapView.Presenter<T> presenter) {
	...
	public void setFuenteRSS(String title) {
		this.fuenteRSSLabel.setText(title); 		
	}

	public void setFuenteRSSLink(String url) {
		this.fuenteRSSLink.setText(url);
		this.fuenteRSSLink.setHref(url);		
	}

	public void setFuenteRSSDetail(String detail) {
		this.fuenteRSSDetailLabel.setText(detail); 
